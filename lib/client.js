...
// client.js TODO
// video viewing
    // show video files sent by client
    // proper agent menu highlighting at left
    // color coding of video boxes to further signal agent identity
// slider response
    // slider (not radio), with discrete labeled options
    // send actual slider data to server, plus timestamps (from client side)
    // animation for slider selections
// general logic / misc
    // handle button disabling until videos are watched, slider is selected
