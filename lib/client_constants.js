...
const BIN_STARTY = 25;
const BINWIDTH = 450;
const BINHEIGHT = 250; // NB: BINWIDTH:BINHEIGHT should be 9:5
const TARGETRAD = 5;
const TARGETSLOPE = 15; // NB: this is the most sensitive variable here
...
const INSTRUCTION_ARRAY = [
    ...
    {
        top_text: "<p>In this experiment, you will be evaluating 3 robots that are each " +
            "shooting a golf ball towards a set of unique targets.</p>",
        canvas_img: "",
        bottom_text: "<p>The 3 robot agents (Agent 1, Agent 2, and Agent 3) will each " +
            "complete 10 shots. Click to watch their performance, paying attention to how well " +
            "each agent is doing.</p>"
    },
    {
        top_text: "<p>After every round, you will be asked to evaluate how close the agent's " +
            "next shot is likely to be to the next target.</p>",
        canvas_img: "",
