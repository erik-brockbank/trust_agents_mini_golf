...
ExperimentHandler.prototype.newExpt = function(client) {
    ...
    var new_expt = {
        ...
        // prolific variables
        "prolific_pid": client.prolific_pid,
        "prolific_study_id": client.prolific_study_id,
        "prolific_session_id": client.prolific_session_id
    };
    console.log("expt.js:\t new experiment: ", new_expt);
...
ExperimentHandler.prototype.startExpt = function(client) {
    ...
    // console.log("expt.js:\t new experiment: ", curr_expt); // DEBUGGING experiment start
...
ExperimentHandler.prototype.recordSurveyData = function(client, data) {
    ...
    if (curr_expt) {
        ...
        this.active_experiments[client.userid] = curr_expt;
        // console.log(curr_expt); // DEBUGGING trial data logging
    }
};
...
ExperimentHandler.prototype.startNextRound = function(client) {
    ...
    if (curr_expt) {
        ...
        curr_expt.trials.push({
            ...
            istest: curr_expt.istest,
            trial_number: curr_expt.trial_index + 1, // 1-indexed
            video_file_shown: curr_expt.trial_order[curr_expt.trial_index],
            // prolific variables
            prolific_pid: curr_expt.prolific_pid,
            prolific_study_id: curr_expt.prolific_study_id,
            prolific_session_id: curr_expt.prolific_session_id
        });
        // notify client
        this.active_experiments[client.userid] = curr_expt;
...
ExperimentHandler.prototype.writeDebriefData = function(client, debrief_data) {
    ...
    if (curr_expt) {
        ...
        debrief_data["prolific_pid"] = curr_expt.prolific_pid;
        debrief_data["prolific_study_id"] = curr_expt.prolific_study_id;
        debrief_data["prolific_session_id"] = curr_expt.prolific_session_id;
